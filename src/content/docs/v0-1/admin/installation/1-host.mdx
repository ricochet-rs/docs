...
Ricochet **requires** Python to be installed via [uv](https://docs.astral.sh/uv/).
...
Ricochet **requires** Julia to be installed via [juliaup](https://github.com/JuliaLang/juliaup).
