...
description = "Default R 4.5 environment"
r = [
...
arch = ["linux/amd64", "linux/arm64"]
r = [
  { version = "4.4.1", bin = "/opt/R/4.4.1/bin/R" },
  { version = "4.4.2", bin = "/opt/R/4.4.2/bin/R" },
]

[image.python-default]
image = "reg.ricochet.rs/ricochet/exec-env-python:3.12"
os = "ubuntu-22.04"
arch = ["linux/amd64", "linux/arm64"]
python = [
  { version = "3.12.0", bin = "/usr/local/bin/python3" },
]
```
