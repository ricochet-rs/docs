...
Refer to the [Deployment Retention](/v0-20/admin/configuration/deployment-retention/) docs in the admin guide for guidance on how retention works, cleanup behavior, and server-wide configuration.

<LinkCard
  title="Deployment Retention"
  href="/v0-20/admin/configuration/deployment-retention/"
