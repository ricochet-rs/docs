...
On a self-hosted instance you can change the default with `default_role` in `ricochet-config.toml`.
See [Configuration Overview](/dev/admin/configuration/0-overview/).
On ricochet Cloud the default is set for you and cannot be changed.
