...
Replace `VERSION` with the desired semver release version (and possibly the respective OS release version).
...
The package installs the `ricochet-server` binary and a `ricochet-server.service` systemd unit.
...
We recommend to use [uv](https://docs.astral.sh/uv/) to install Python interpreters:

```sh
uv python install <version>
```

You can also use your distribution's package manager or [pyenv](https://github.com/pyenv/pyenv).

### R

We recommend to use [rig](https://github.com/r-lib/rig) to install R interpreters:
...
Install Julia from the [official downloads page](https://julialang.org/downloads/) or via [juliaup](https://github.com/JuliaLang/juliaup).
