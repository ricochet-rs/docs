...
<Aside type="caution">
Environment variables are useful for containerized deployments or sensitive credentials, but **TOML configuration is recommended** whenever possible as it's easier to manage and version control.
</Aside>
