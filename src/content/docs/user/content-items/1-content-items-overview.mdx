...
All tasks can be [scheduled](/user/content-items/4-scheduled-content) (or [invoked via API](/user/tasks/1-invoke)). A subset of tasks can be served as a [**static html** website](/user/content-items/3-static-content)—for example R Markdown and Quarto documents or websites.
...
| `serverless-r`   | R functions deployed as a service (see [Serverless R](/user/content-items/5-serverless-r))          |
