...
- ricochet uses the subject identifier from your OIDC IDP as the user ID.
- At present the `email` is unused but is collected for future integrations with an SMTP server.
