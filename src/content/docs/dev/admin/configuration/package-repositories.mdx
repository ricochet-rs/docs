...
Add a `[package]` section to `ricochet-config.toml` to set server-wide defaults.
...
| Field              | Description                                                                                                     |
| ------------------ | --------------------------------------------------------------------------------------------------------------- |
| `allow_overrides`  | When `true`, individual content items can define their own package sources in `_ricochet.toml`. Default `false`. |
...
How package sources are resolved depends on the `[package]` configuration:

| Server `[package]` set? | `allow_overrides` | Behavior                                                                                      |
| ----------------------- | ----------------- | --------------------------------------------------------------------------------------------- |
