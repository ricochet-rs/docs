...
For a fresh server install, run `ricochet bootstrap all` to install all suggested system dependencies. To install multiple versions of R specify the versions like so `ricochet bootstrap all --versions 4.5.0 4.1.3` flag.
