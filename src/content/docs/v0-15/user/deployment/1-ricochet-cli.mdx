...
```
https://s3.eu-central-003.backblazeb2.com/ricochet-cli/$VERSION/ricochet-$VERSION-$OS_ARCH.tar.gz
```
...
See [Using `_ricochet.toml`](/v0-15/user/deployment/2-ricochet-toml) for configuration details.
