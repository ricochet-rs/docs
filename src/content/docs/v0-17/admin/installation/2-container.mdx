...
- For multi-node setups, use the [Kubernetes installation](/v0-17/admin/installation/3-kubernetes/) instead of a standalone container.
- The [container backend](/v0-17/admin/configuration/execution-backend/#container-backend) is for ricochet-server running on the host next to a container daemon, not for ricochet-server in a container.
...
To enforce per-item limits, use a [host install](/v0-17/admin/installation/1-host/) or [Kubernetes](/v0-17/admin/installation/3-kubernetes/).
