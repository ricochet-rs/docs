...
See [File Logging](/v0-16/admin/configuration/file-logging/) for configuration options.
...
See the [storage configuration](/v0-16/admin/configuration/0-overview/#storage) for more details.
