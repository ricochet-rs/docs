...
Refer to the [Deployment Retention](/v0-13/admin/configuration/deployment-retention/) docs in the admin guide for guidance on how retention works, cleanup behavior, and server-wide configuration.

<LinkCard
  title="Deployment Retention"
  href="/v0-13/admin/configuration/deployment-retention/"
