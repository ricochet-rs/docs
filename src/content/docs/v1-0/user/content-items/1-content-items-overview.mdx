...
All tasks can be [scheduled](/v1-0/user/content-items/4-scheduled-content) (or [invoked via API](/v1-0/user/tasks/1-invoke)). A subset of tasks can be served as a [**static html** website](/v1-0/user/content-items/3-static-content)—for example R Markdown and Quarto documents or websites.
...
| `serverless-r`   | R functions deployed as a service (see [Serverless R](/v1-0/user/content-items/5-serverless-r))     |
